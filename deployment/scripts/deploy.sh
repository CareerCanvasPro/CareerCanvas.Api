...
# Move PM2 startup setup after all services are started
echo -e "${PURPLE}[Deploy.sh]:${NC} Setting up PM2 startup script..."
STARTUP_CMD="sudo env PATH=$PATH:/home/deploy/.nvm/versions/node/v18.20.6/bin pm2 startup systemd -u deploy --hp /home/deploy"
echo "$STARTUP_CMD" | sudo -S bash || true
