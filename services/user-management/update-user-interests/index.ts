...
import { updateUserInterests } from "./users.db.service";
...
export const handler = async (
  ...
  try {
    ...
    const { interests } = JSON.parse(event.body ? event.body : "");

    const { error, value: validatedInterests } = stringArrayValidator.validate(
      interests,
      {
        abortEarly: false,
      }
